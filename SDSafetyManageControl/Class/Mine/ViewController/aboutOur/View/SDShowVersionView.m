...
@implementation SDShowVersionView
...
-(void)createView{
    ...
    titleLab.text = @"您是否确认退出平台";
    titleLab.numberOfLines = 0;
    titleLab.font = [UIFont systemFontOfSize:13];
    titleLab.textColor = [UIColor colorWithHexString:@"#6c6c6c"];
    ...
    [trueBtn setTitle:@"立即升级" forState:UIControlStateNormal];
