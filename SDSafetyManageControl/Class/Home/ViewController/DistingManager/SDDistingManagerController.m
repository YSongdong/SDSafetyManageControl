...
@interface SDDistingManagerController ()
<
UITableViewDelegate,
...
@implementation SDDistingManagerController
...
//设置导航栏
-(void)createNavi{
    [self customNaviItemTitle:@"识别列表" titleColor:[UIColor colorTextWhiteColor]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SDDistingDetailController *detaVC = [[SDDistingDetailController alloc]init];
    detaVC.attendanceIdStr = dict[@"AttendanceId"];
