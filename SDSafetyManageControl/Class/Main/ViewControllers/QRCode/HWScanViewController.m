...
#pragma mark ---- 设置导航栏----
-(void) createNavi{
    [self customNaviItemTitle:@"二维码/条形码" titleColor:[UIColor colorTextWhiteColor]];
    [self customTabBarButtonimage:@"btn_back_white" target:self action:@selector(backBtn:) isLeft:YES];
    
   //  [self customTabBarButtonimage:@"btn_back_white" target:self action:@selector(photoBtnOnClick) isLeft:NO];
}
...
//        NSLog(@"-------%@---",metadataObjects);
        ...
        self.tureBtnBlock([[metadataObjects firstObject]stringValue]);
